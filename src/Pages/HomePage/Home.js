...
//               <button className="absolute bottom-1/2 left-[38%] transform -translate-x-1/2 bg-[#FFEE00] px-4 py-2 rounded-[23px] opacity-0 transition duration-300 group-hover:opacity-100">
//                 Add to Cart
//               </button>
//             </div>
//           ))}
